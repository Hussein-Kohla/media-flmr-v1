  ...
  return (
    <input
      ...
      className={cn(
        ...
        "flex dark:bg-zinc-900/50",
        "[&::-webkit-calendar-picker-indicator]:invert [&::-webkit-calendar-picker-indicator]:opacity-100 [&::-webkit-calendar-picker-indicator]:cursor-pointer",
        className
      )}
      {...props}
    />
