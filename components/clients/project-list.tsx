  ...
  return (
    ...
    {projects.map((project) => {
      ...
      return (
        ...
        <Button variant="ghost" size="icon" onClick={() => onEdit(project)} className="h-8 w-8">
        <Edit2 className="h-4 w-4" />
        </Button>
        <Button variant="ghost" size="icon" onClick={() => onDelete(project._id)} className="h-8 w-8 text-destructive">
        ...
        <Badge variant={project.paymentStatus === "paid" ? "default" : "secondary"} className="capitalize">
